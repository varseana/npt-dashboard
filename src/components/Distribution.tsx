...
const csvBtn: React.CSSProperties = { marginLeft: "auto", background: palette.text, color: "#fff", border: "none", borderRadius: 8, padding: "8px 14px", fontSize: 15, cursor: "pointer", fontWeight: 600 };
